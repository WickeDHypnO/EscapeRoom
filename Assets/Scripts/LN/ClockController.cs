...
public class ClockController : MonoBehaviour
{
	...
	void Start ()
    {
        ...
        direction = 1.0f;
        oneOverTimeScale = 1.0f / TimeScale;
    }
	...
	void Update ()
    {
        ...
        float scaledDelta = delta * oneOverTimeScale;
        ...
        if (elapsedTime >= TimeScale)
        {
            ...
            pendulumZ = (oldDir * PendulumAngle) + (direction * PendulumAngle * 2.0f * elapsedTime * oneOverTimeScale);
        }
